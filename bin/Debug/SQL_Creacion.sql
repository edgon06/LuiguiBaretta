...
Go
ALTER LOGIN SECRETARIA_LOGIN WITH DEFAULT_DATABASE = LuiguiBaretta
Go
CREATE login ADMINISTRADOR_LOGIN WITH Password ='123'
Go
ALTER LOGIN ADMINISTRADOR_LOGIN WITH DEFAULT_DATABASE = LuiguiBaretta
Go
use LuiguiBaretta
Go
